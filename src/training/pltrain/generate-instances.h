...
#ifndef GENERATE_INSTANCES_H_
#define GENERATE_INSTANCES_H_
...
bool init_params(int argc, char** argv, po::variables_map* cfg) {
	stringstream ss;
	ss << "\nGenerates Instances for pltrain.\n"
	...
	cl.add_options()
			("input,i",				po::value<string>(),					"input file. Use '-' for STDIN. USE SINGLE SENTENCE QUERIES")
			...
			("ascii,a",				po::value<bool>()->zero_tokens(),		"save Instances as ascii text.")
